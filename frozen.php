...
<link rel="stylesheet" type="text/css" href="css/main.css">
	...
	<body style="background-color:lightgrey;">
		...
		<div class="__search_result_block">
			    ...
			    <a href="frozenfries.php" style="text-decoration: none"><h1 >Mccain fries</h1>
                   <img src="../assets/images/frozenfries.jpg" title="Mccain fries"></a>
                    <br>
                    <br>
                    ...
                    <form action="itemDescription.php?id=39">
                        ...
                        <input type="button" value="Add to cart" onclick="cart.void_add(
                            new Item(39, 'mccain fries', 'frozen, mccain fries, mccain, frozen fries, fries, food', 'frozenfries.jpg', 3.99, 20, 1)
                            )">
                    </form>
                   </div>
                </div>
