	...
	<body >
		...
		<div class="beverage_page">
				...
				<div class="beverage_left">
					<img src="../assets/images/sprite.jpg" style="width:80%; height=80%;" alt="Sprite Can">
				</div>

				<div class="beverage_right">
					<h1 style="font-size:48; padding:2%; background-color:white;">Sprite (355mL Can)</h1><br>
					<p style="font-size:24px">A 355mL Can of Sprite. Also comes in 710mL and 2L varieties.</p>
					...
					<input type="text" style="padding-top:10px; padding-bottom:10px; padding-left:5px;" placeholder="Indicate quantity" formaction="">
