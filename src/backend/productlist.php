	...
	<table style="width:100%" >
		...
		<td><pre>  </pre></td>
			...
			<tr>
				...
				<td style="text-align:center;"><h2>20</h2></td>
			
				<td style="text-align:center;"><h2>$1.99</h2></td>

				<td style="text-align:center;">
				<form method="POST">
					<ul>
					<input type="submit" name="__tag_search_btn" value="add" formaction="productedit.php">
					</ul>
				</form>
				</td>
				...
				<form method="POST">
					<ul>
					<input type="submit" name="__tag_search_btn" value="edit" formaction="productedit.php">
					</ul>
				</form>
				</td>
			</tr>
	...
	<table style="width:100%" >
		...
		<td><pre>  </pre></td>
			...
			<tr>
				...
				<td style="text-align:center;"><h2>30</h2></td>
		
				<td style="text-align:center;"><h2>$1.49</h2></td>
	...
	<table style="width:100%" >
		...
		<td><pre>  </pre></td>
			...
			<tr>
				...
				<td style="text-align:center;"><h2>10</h2></td>
		
				<td style="text-align:center;"><h2>$4.99</h2></td>
