...
<body>
  ...
  <div id="menu">
    <ul>
      <li onclick="goto('productlist.php')">
    ...
    <div class="border_products_list">
      <table class="table_products_list">
        ...
        <tr>
          ...
          <td class="data_cell_table">
            <div>
              <input type="text" class="inputs_table" placeholder="STOCK"/>
            </div>
          </td>
          <td class="data_cell_table">
            <div>
              <input type="text" class="inputs_table" placeholder="PRICE"/>
            </div>
          </td>
          <td class="data_cell_table">
            <div>
              <form method="POST">
                <input type="submit" class="btn_products_list" value="Save" formaction="productlist.php"/>
              </form>
            </div>
          </td>
        </tr>
