	...
	<div id="__top_banner">
		...
		<a href="cart.php">
			<button id="cart_button">
				<br/>
				<br/>
				<img src="../assets/Icons/cart.png" alt="cart image" style="float:left; margin-right:0.5em" width="25" height="25"/>
		...
		<table style="padding:2%; width:100%;">
			<tr>
				<th class="vegetables_left">
					<img src="../assets/images/cucumbers.jpg" style="width:80%" alt="cucumbers image"/>
				</th>
				<th class="vegetables_right" colspan="4">
					...
					<p style="font-size:24px">
						Cucumbers freshly grown from your local farms.
					</p>
					...
					<button type="submit" class="product_option_btn">
						A bag of 5 cucumbers
					</button>
					<button type="submit" class="product_option_btn">
						A bag of 10 cucumbers
					</button>
					<button type="submit" class="product_option_btn">
						A bag of 25 cucumbers
					</button>
					<br/>
					<br/>
					<br/>
				...
				<tr>
					...
					<th>
						<a href="https://www.facebook.com/Caliprex-121401789649042" target="_blank">
							<image src="assets/Icons/facebook.png" alt="Facebook image"style="float:right; margin-right:0.5em" width="50" height="35"/>
						</a>
					</th>
					<th>
						<a href="https://www.instagram.com/caliprex/" target="_blank">
							<image src="assets/Icons/instagram.png" alt="Instagram image" style="float:right; margin-right:0.5em" width="50" height="35"/>
						</a>
					</th>
					<th>
						<a href="https://twitter.com/caliprex" target="_blank">
							<image src="assets/Icons/twitter.png" alt="Twitter image" style="float:right; margin-right:0.5em" width="50" height="35"/>
						</a>
					</th>
					<th>
						<a href="https://Pintrest.com/caliprex" target="_blank">
							<image src="assets/Icons/pinterest.png" alt="Pintrest image" style="float:right; margin-right:0.5em" width="50" height="35"/>
						</a>
					</th>
					<th>
						<a href="https://www.youtube.com/channel/UCvZRW67axwzk6fw5dBSw-iQ?view_as=subscriber" target="_blank">
							<image src="assets/Icons/youtube.png" alt="Youtube image" style="float:right; margin-right:0.5em" width="50" height="35"/>
						</a>
					</th>
					<th>
