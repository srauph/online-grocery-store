		...
		<table style="padding:2%; width:100%;">
			<tr>
				<th class="vegetables_left">
					<img src="../assets/images/tomato.jpg" style="width:80%" alt="tomatoes image"/>
				</th>
				<th class="vegetables_right" colspan="4">
					...
					<p style="font-size:24px">
						Tomatoes freshly grown from your local farms.
					</p>
					...
					<button type="submit" class="product_option_btn">
						A bag of 10 tomatoes
					</button>
					<button type="submit" class="product_option_btn">
						A bag of 25 tomatoes
					</button>
					<br/>
					<br/>
					<br/>
