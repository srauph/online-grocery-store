...
<body>
    ...
    function saveSessionData() {
        sessionStorage.twixQty = bars;
    }
    function loadSessionData() {
        if (sessionStorage.twixQty) {
            void_updateNumber(sessionStorage.twixQty);
        }
    }
    ...
    //     cart.void_add(new Item(122, 'Twix', 'twix, chocolat', 'twix.jpg', 1.49, 1, 0, ''), bars);
    // }

    function void_addItemsToCart() {
        cart.void_add(new Item(122, 'Twix', 'twix, chocolat', 'twix.jpg', 1.49, parseInt(bars), 3, 0, ''));
    }
