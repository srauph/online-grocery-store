...
<h1>We're improving! If you have any questions, comments or suggestions about a store
  ...
  <table>
      <tr>
<td><h1>Canada:</h1></td> 
    <td class="red"><h1>514-553-4360</h1></td>
</tr>
</table>
...
<tr>
    ...
    <td><h1 style="color:grey; "> to change your orders delivery time</h1></td>
    <td><h1 style="color:grey;">to cancel your order</h1></td>
</tr>
</table>
<br>
<br>
...
<h3>If you have any questions, comments or suggestions about a store or a service offered online or in-store,
...
<form method="POST">
    ...
    <input type="text"style="height:45px;font-size:20;width:390px;" name="First Name" placeholder="Enter your first Name"/><br/></th>
    <td></td>
    <td></td>
    <td></td>
    <td></td>
    ...
    <input type="Email" style="height:45px;font-size:20;width:390px;" name="Last Name" placeholder="Enter your Last Name"/><br/></th>
    </table>
    <br>
    <br>
    <br>
    ...
    <input type="text" style="height:45px;font-size:20;width:390px" name="Email Address" placeholder="Enter your Email Address"/><br/></th>
    <td></td>
    <td></td>
    <td></td><td></td>
    <td></td>
    ...
    <input type="text"  style="height:45px;width:390px;font-size:20;" name="Phone" placeholder="Enter your Phone Number"/><br/></th>
    </table>
    <br>
    <br>
    <label><h1>Comments</h1></label>
    <input type="text" style="height:180px;font-size:30;width:700px;" name="Phone" placeholder="Enter your Comments"/><br/>
<br>
</form>
</div>
<div class="border2">
